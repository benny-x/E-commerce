...
public class MyCommentsController extends BaseController {
    ...
    @ApiOperation(value = "查询未评价", notes = "查询我的未评价", httpMethod = "POST")
    @PostMapping("/pending")
    ...
    @ApiOperation(value = "提交评价", notes = "提交商品评价列表", httpMethod = "POST")
    ...
    @ApiOperation(value = "查询已评价", notes = "查询我的已评价", httpMethod = "POST")
    @PostMapping("/query")
